...
tag @e[tag=vp_game_select_ui_next_button,limit=1] add iframe_interaction
...
tag @e[tag=vp_game_select_ui_last_button,limit=1] add iframe_interaction
...
tag @e[tag=vp_game_select_ui_rand_button,limit=1] add iframe_interaction
...
tag @e[tag=vp_game_select_ui_start_button,limit=1] add iframe_interaction