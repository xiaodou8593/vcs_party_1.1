#vp_core:guis/souvenirs_shop/enter
...
# 页面信息
execute unless data storage iframe:io player.page_data run function vp_core:guis/souvenirs_shop/init_page_data
function iframe:player_space/_store

function vp_core:guis/souvenirs_shop/items