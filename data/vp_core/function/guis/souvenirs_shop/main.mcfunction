#vp_core:guis/souvenirs_shop/main
...
# 购买检测
execute if score temp_n int = temp_len int run function vp_core:guis/souvenirs_shop/buy_check
# 异步加载页面
execute if score temp_n int < temp_len int run function vp_core:guis/souvenirs_shop/iter_page_data

execute unless data storage iframe:io ender[{Slot:9b}].components."minecraft:custom_data"{button:9b} run function vp_core:guis/souvenirs_shop/last_page
execute unless data storage iframe:io ender[{Slot:17b}].components."minecraft:custom_data"{button:17b} run function vp_core:guis/souvenirs_shop/next_page
execute unless data storage iframe:io ender[{Slot:20b}].components."minecraft:custom_data"{button:20b} run function vp_core:guis/souvenirs_shop/list_0
execute unless data storage iframe:io ender[{Slot:21b}].components."minecraft:custom_data"{button:21b} run function vp_core:guis/souvenirs_shop/list_1
execute unless data storage iframe:io ender[{Slot:22b}].components."minecraft:custom_data"{button:22b} run function vp_core:guis/souvenirs_shop/list_2
execute unless data storage iframe:io ender[{Slot:23b}].components."minecraft:custom_data"{button:23b} run function vp_core:guis/souvenirs_shop/list_3
...
execute if score update_gui int matches 1 run function vp_core:guis/souvenirs_shop/items
