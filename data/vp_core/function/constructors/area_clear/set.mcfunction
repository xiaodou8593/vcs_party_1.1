#vp_core:constructors/area_clear/set
# vp_core:constructors/area_clear/_new调用
...
# 获取模块编号
scoreboard players operation @s module_id = #vp_core:constructors/area_clear/ module_id