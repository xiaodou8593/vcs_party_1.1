#vp_core:constructors/barrier_builder/_store
# 临时对象赋值到实体对象
# 输入执行实体
...
scoreboard players operation @s x_index = x_index int
scoreboard players operation @s y_index = y_index int
scoreboard players operation @s z_index = z_index int