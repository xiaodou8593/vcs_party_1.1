#vp_core:constructors/barrier_builder/_get
# 实体对象赋值到临时对象
# 输入执行实体
...
scoreboard players operation x_index int = @s x_index
scoreboard players operation y_index int = @s y_index
scoreboard players operation z_index int = @s z_index