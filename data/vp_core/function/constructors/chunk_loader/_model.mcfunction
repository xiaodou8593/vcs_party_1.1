#vp_core:constructors/chunk_loader/_model
# 使用临时对象构建数据模板
# 输出数据模板storage vp_core:io result

data modify storage vp_core:io result set value {vp_progress:0, field_size:0, field_height:0, field_center:[0.0d, 0.0d, 0.0d], field_index:0, structure_prefix:"", load_area_uuid:""}
...
data modify storage vp_core:io result.load_area_uuid set from storage vp_core:io load_area_uuid