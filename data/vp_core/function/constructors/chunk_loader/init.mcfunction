#vp_core:constructors/chunk_loader/init
# 初始化chunk_loader模块
...
# 注册本模块
data modify storage module_control:io input set value {prefix:"vp_core:constructors/chunk_loader/",namespace:"vp_core"}
function module_control:data/_reg
scoreboard players operation #vp_core:constructors/chunk_loader/ module_id = res int
...
data modify storage vp_core:io load_area_uuid set value ""

scoreboard objectives add vp_progress dummy

function vp_core:constructors/chunk_loader/_class