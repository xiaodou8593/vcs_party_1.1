#vp_core:constructors/structure_builder/init
# 初始化structure_builder模块
...
# 注册本模块
data modify storage module_control:io input set value {prefix:"vp_core:constructors/structure_builder/",namespace:"vp_core"}
function module_control:data/_reg
scoreboard players operation #vp_core:constructors/structure_builder/ module_id = res int
...
function vp_core:constructors/structure_builder/_class